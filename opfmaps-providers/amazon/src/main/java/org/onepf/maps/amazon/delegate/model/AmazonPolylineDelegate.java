 ...
 * @since 31.07.2015
 */
public final class AmazonPolylineDelegate implements PolylineDelegate {

    @NonNull
    private final Polyline polyline;

    public AmazonPolylineDelegate(@NonNull final Polyline polyline) {
    ...
    public List<OPFLatLng> getPoints() {
        ...
        for (LatLng amazonPoint : amazonPoints) {
            points.add(new OPFLatLng(new AmazonLatLngDelegate(amazonPoint)));
        }
