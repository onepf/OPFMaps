...
public final class GoogleGroundOverlayDelegate implements GroundOverlayDelegate {
    ...
    public GoogleGroundOverlayDelegate(@NonNull final GroundOverlay groundOverlay) {
    ...
    public OPFLatLngBounds getBounds() {
        return new OPFLatLngBounds(new GoogleLatLngBoundsDelegate(groundOverlay.getBounds()));
    }
    ...
    public OPFLatLng getPosition() {
        return new OPFLatLng(new GoogleLatLngDelegate(groundOverlay.getPosition()));
    }
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof GoogleGroundOverlayDelegate)) return false;

        return groundOverlay.equals(((GoogleGroundOverlayDelegate) other).groundOverlay);
    }
    //CHECKSTYLE:ON
