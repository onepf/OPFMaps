 ...
 * @since 31.07.2015
 */
public final class GoogleCircleDelegate implements CircleDelegate {

    @NonNull
    private final Circle circle;

    public GoogleCircleDelegate(@NonNull final Circle circle) {
        this.circle = circle;
    }
    ...
    public OPFLatLng getCenter() {
        return new OPFLatLng(new GoogleLatLngDelegate(circle.getCenter()));
    }
