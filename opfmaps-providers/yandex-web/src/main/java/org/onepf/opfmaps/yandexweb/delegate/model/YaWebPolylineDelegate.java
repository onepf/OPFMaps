 ...
 * @since 02.09.2015
 */
public final class YaWebPolylineDelegate implements PolylineDelegate {

    @NonNull
    private final Polyline polyline;

    public YaWebPolylineDelegate(@NonNull final Polyline polyline) {
    ...
    public List<OPFLatLng> getPoints() {
        ...
        for (LatLng yaWebPoint : yaWebPoints) {
            points.add(new OPFLatLng(new YaWebLatLngDelegate(yaWebPoint)));
        }
    ...
    public void setPoints(@NonNull final List<OPFLatLng> points) {
        ...
        polyline.setPoints(yaWebPoints);
    }
    ...
    public boolean equals(final Object other) {
        return other != null
                && (other == this || other instanceof YaWebPolylineDelegate
                && polyline.equals(((YaWebPolylineDelegate) other).polyline));
    }
}
