...
public final class YaWebGroundOverlayDelegate implements GroundOverlayDelegate {
    ...
    public YaWebGroundOverlayDelegate(@NonNull final GroundOverlay groundOverlay) {
    ...
    public OPFLatLngBounds getBounds() {
        return new OPFLatLngBounds(new YaWebLatLngBoundsDelegate(groundOverlay.getBounds()));
    }
    ...
    public OPFLatLng getPosition() {
        return new OPFLatLng(new YaWebLatLngDelegate(groundOverlay.getPosition()));
    }
    ...
    public boolean equals(final Object other) {
        return other != null
                && (other == this || other instanceof YaWebGroundOverlayDelegate
                && groundOverlay.equals(((YaWebGroundOverlayDelegate) other).groundOverlay));
    }
