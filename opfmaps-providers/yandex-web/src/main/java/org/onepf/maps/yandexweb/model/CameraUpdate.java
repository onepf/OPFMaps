...
public final class CameraUpdate {
    ...
    private CameraUpdate(@NonNull final CameraUpdateSource cameraUpdateSource,
                         @Nullable final LatLng center,
                         @Nullable final LatLngBounds bounds,
    ...
    static final class Builder {
        ...
        @NonNull
        Builder setCenter(@NonNull final LatLng center) {
            this.center = center;
            return this;
        }

        @NonNull
        Builder setBounds(@NonNull final LatLngBounds bounds) {
            this.bounds = bounds;
            return this;
        }
