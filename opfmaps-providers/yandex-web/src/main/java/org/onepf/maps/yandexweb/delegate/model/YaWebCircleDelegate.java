...
public final class YaWebCircleDelegate implements CircleDelegate {
    ...
    public YaWebCircleDelegate(@NonNull final Circle circle) {
        this.circle = circle;
    }
    ...
    public OPFLatLng getCenter() {
        return new OPFLatLng(new YaWebLatLngDelegate(circle.getCenter()));
    }
    ...
    public boolean equals(final Object other) {
        return other != null
                && (other == this || other instanceof YaWebCircleDelegate
                && circle.equals(((YaWebCircleDelegate) other).circle));
    }
